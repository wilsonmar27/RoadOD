...
wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=1kURf2AhCrtQ2K2POU7QOxp_eWHb2QGvm' -O G2dataSetV03.zip
unzip G2dataSetV03.zip
unzip G2datasetIMG.zip

# restore dataset with original organization
mv dataSetV03/ road/
cd road
mv dataSetV03/trainv1text/* trainv1/
mv dataSetV03/trainv2text/* trainv2/
mv dataSetV03/trainv3text/* trainv3/
mv dataSetV03/trainv4text/* trainv4/
mv dataSetV03/trainv5text/* trainv5/
mv dataSetV03/trainv6text/* trainv6/
rm -r dataSetV03
